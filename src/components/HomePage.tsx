...
export function HomePage(){
    ...
    return(  
        <div>
            ...
            <MultiSelectSearch title='Top 100 Films' options={top100Films}/>
            <SingleSelect title='singleselect' carOptions={cars}/>
            {cars.map((data)=>{
              return(
                <CheckBox inputClsName='checkBoxCls' val={data.modal} labelName={data.modal} />
              )
            })}
            <InputTag />
            <RangePicker />
